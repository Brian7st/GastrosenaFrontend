...
export function gilFromApi(dto: GilResponse): SolicitudGil {
  return {
    ...
    fecha: dto.fechaSolicitud,
    centroFormacionId: String(dto.centroCostosCodigo ?? ''),
    area: dto.area,
    ...
    destino: dto.destinoBienes,
    fichaId: dto.fichaCaracterizacion,
    estado: dto.estado,
    programaId: dto.codigoGrupo,
    emitidoPor: dto.jefeOficinaCoordinador ?? dto.solicitante,
    resultadoAprendizaje: undefined,
    actividades: undefined,
    voceroNombre: undefined,
    voceroDocumento: undefined,
    solicitudesOrigenIds: undefined,
