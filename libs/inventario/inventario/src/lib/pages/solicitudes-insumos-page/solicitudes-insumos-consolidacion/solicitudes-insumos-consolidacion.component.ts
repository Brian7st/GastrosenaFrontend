...
import { PageHeaderComponent, ButtonComponent } from '@restaurant/shared/ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, PageHeaderComponent, ButtonComponent, BackButtonComponent],
