...
export class RequisicionesCreateComponent implements OnInit {
  ...
  readonly CATEGORIAS: CategoriaMeta[] = [
    { key: 'Perecederos',             label: 'Perecederos',            subtitulo: 'Carnes, lácteos y frescos',           icono: 'flame'        },
    { key: 'Fruver',                  label: 'Fruver',                 subtitulo: 'Frutas y verduras frescas',           icono: 'leaf'         },
    { key: 'Abarrotes y Secos',       label: 'Abarrotes y Secos',      subtitulo: 'Granos, aceites, harinas y enlatados', icono: 'package'     },
    { key: 'Bebidas y Liquidos',      label: 'Bebidas y Líquidos',     subtitulo: 'Jugos, agua y bebidas',               icono: 'coffee'       },
    { key: 'Reposteria y Congelados', label: 'Repostería y Congelados', subtitulo: 'Postres, helados y congelados',      icono: 'snowflake'    },
  ];
