...
export class ReportesPageComponent {
  ...
  readonly periodicidadSeleccionada = signal('');
  ...
  readonly reportesRecientes: ReporteReciente[] = [
    { nombre: 'Facturación Marzo 2025', fecha: '2025-04-01', estado: 'Completado' },
    { nombre: 'Inventario Trimestre Q1 2025', fecha: '2025-03-31', estado: 'Completado' },
    { nombre: 'Presupuesto Febrero 2025', fecha: '2025-03-02', estado: 'Completado' },
    { nombre: 'Ventas por Mesero Marzo 2025', fecha: '2025-04-02', estado: 'Completado' },
    { nombre: 'Desempeño Aprendices Q1 2025', fecha: '2025-03-30', estado: 'Completado' },
  ];
  ...
  descargarPdf(reporteId: string): void {
    console.log('Descargando PDF:', reporteId);
  }
}