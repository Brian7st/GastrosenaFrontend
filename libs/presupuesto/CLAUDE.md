...
Estás trabajando en el dominio **presupuesto** de GastroSENA.

## Tus permisos
- Modificar: libs/presupuesto/**
- Leer: libs/shared/** (solo para importar, nunca modificar)
- Todo lo demás está fuera de tu alcance

## Antes de cualquier cambio
Lee .ai/domains/presupuesto.md para las reglas específicas de este dominio.
...
eat(presupuesto): ... | ix(presupuesto): ... | chore(presupuesto): ...
