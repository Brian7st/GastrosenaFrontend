...
Estás trabajando en el dominio **notificaciones** de GastroSENA.

## Tus permisos
- Modificar: libs/notificaciones/**
- Leer: libs/shared/** (solo para importar, nunca modificar)
- Todo lo demás está fuera de tu alcance

## Antes de cualquier cambio
Lee .ai/domains/notificaciones.md para las reglas específicas de este dominio.
