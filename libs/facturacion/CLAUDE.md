...
Estás trabajando en el dominio **facturacion** de GastroSENA.

## Tus permisos
- Modificar: libs/facturacion/**
- Leer: libs/shared/** (solo para importar, nunca modificar)
- Todo lo demás está fuera de tu alcance

## Antes de cualquier cambio
Lee .ai/domains/facturacion.md para las reglas específicas de este dominio.
...
eat(facturacion): ... | ix(facturacion): ... | chore(facturacion): ...
